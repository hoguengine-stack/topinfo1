  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-blue-600/10 selection:text-blue-600 transition-all duration-300 overflow-x-hidden">
      ...
      <main className="py-12 md:py-16">
        ...
        {currentUrl === "request_consult" && <ConsultationForm />}
        {currentUrl === "request_paper" && <PaperRollRequestForm />}
        {currentUrl === "board_suggestions" && <SuggestionBoard />}
        {currentUrl === "board_resources" && <ResourceBoard />}

        {/* --- Hardcoded Hardware Catalog page --- */}
        {currentUrl === "products" && (
          <div className="max-w-5xl mx-auto px-6 space-y-10">
            <div className="text-center max-w-xl mx-auto">
              <h2 className="text-3xl font-extrabold text-slate-955 tracking-tight text-center">탑정보통신 프리미엄 결제 하드웨어</h2>
              <p className="text-slate-500 text-sm mt-3 text-center">신규 매장에 가장 잘 어울리는 화이트 슬림 디자인과 다채로운 결제 연동 리스트입니다.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left mt-8">
              {products
                ...
                .map((p) => {
                  ...
                  return (
                    <div key={p.id} className="bg-white border border-slate-100 rounded-3xl overflow-hidden hover:shadow-lg hover:border-slate-200/80 transition-all duration-300 flex flex-col justify-between relative group/prod">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={async (e) => {
                                    ...
                                    setProducts(updated);
                                    await updateDoc(doc(db, "products", p.id), { name: e.target.value });
                                  }}
                              ...
                              <div>
                                ...
                                <textarea
                                  ...
                                  onChange={async (e) => {
                                    ...
                                    setProducts(updated);
                                    await updateDoc(doc(db, "products", p.id), { description: e.target.value });
                                  }}
                              ...
                              <div>
                                ...
                                <select
                                  ...
                                  onChange={async (e) => {
                                    ...
                                    setProducts(updated);
                                    await updateDoc(doc(db, "products", p.id), { category: val });
                                  }}
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={async (e) => {
                                    ...
                                    setProducts(updated);
                                    await updateDoc(doc(db, "products", p.id), { imageUrl: e.target.value });
                                  }}
                                      ...
                                      <div key={idx} className="flex items-center gap-1.5">
                                        ...
                                        <input
                                          ...
                                          onChange={async (e) => {
                                            ...
                                            setProducts(updated);
                                            await updateDoc(doc(db, "products", p.id), { features: nextFeatures });
                                          }}
                        ...
                        {isEditModeActive ? (
                          <input
                            ...
                            onChange={async (e) => {
                              ...
                              setProducts(updated);
                              await updateDoc(doc(db, "products", p.id), { price: e.target.value });
                            }}
